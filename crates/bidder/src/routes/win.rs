...
pub async fn handle(
    ...
    // Retrieve + delete the pending impression we stored at bid time
    ...
    // Correct the spend delta (we reserved bid_price; actual charge is clearing_price)
    ...
    // Write impression event to PostgreSQL
